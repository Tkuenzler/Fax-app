...
import framelisteners.edit.PVerifyCheckDoctor;
...
import framelisteners.file.SendToCarepointDatabase;
...
public class CSVFrame extends JFrame  {
	...
	private JMenuBar setToolbar() {
		...
		file.add(item);
		file.addSeparator();
		item = new JMenuItem("Send PDF to Carepoint Database");
		item.addActionListener(new SendToCarepointDatabase());
		file.add(item);
		...
		edit.add(item);
		item = new JMenuItem("Use PVerify to get Correct Doctor");
		item.addActionListener(new PVerifyCheckDoctor());
		edit.add(item);
		bar.add(edit);
		//Settings
